...
const HomePage = () => {
  ...
  return (
    <div className="homepage">
                <h1 className="names">The Christian Youth: Separated Unto the Lord </h1>

      <main className="main-content">
        <div className="intro">
          {/* <span className="intro-tag">It's me</span> */}
          <p className = "contentt">Let no man despise <span className="highlight designer">thy youth;</span> but be thou an example of the believers, in word, in conversation, in charity, in spirit, in faith, in purity. <span className="highlight developer">1Tim 4:12</span></p>
